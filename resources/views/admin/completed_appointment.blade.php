...
<div class="dropdown">
   ...
   <div class="container">
    <div class="titlebar">
        ...
        <span class="badge bg-success mb-2" style="text-transform:uppercase">Completed</span>
 ...
 @foreach ($data as $row)
                <div class="card shadow mb-2 searchfilter">
                    <div class="card-header">
                       ...
                       5px" class="text-success"><i class="fas fa-check-circle"></i></span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <br>
                            <h6 style="font-size:13px" class="text-secondary">Medical Certificate</h6>
 ...
 --}}
                                    <h6 class="af" style="font-size: 12px">Remarks</h6>
                           <span class="text-success" style="font-size:15px"> {{$row->remarks}}</span>
