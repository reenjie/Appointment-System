        ...
        <span style="font-size:12px;cursor: default;">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item text-primary" aria-current="page">Approved</li>
            ...
            <div class="col-md-8">
                ...
                --}}
                                   ...
                                   <div class="card-footer">
                                    <h6 style="font-size:13px">Status: <span class="badge text-bg-success" style="padding: 5px;font-size:12px">Approved</span></h6>
                                   </div>
                               </div>
                               @endforeach 
                               @else 
